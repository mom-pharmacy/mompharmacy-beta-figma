...
const COLS = 5;
const ROWS = 9;
const SPACING = wp('2%'); // Responsive spacing

const generateBackgroundLayout = (cols = COLS, rows = ROWS, spacing = SPACING) => {
  const cellWidth = wp(`${100 / cols}%`);
  const cellHeight = hp(`${100 / rows}%`);
  const items = [];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.logoContainer}>
        <Image
          source={require('../../assets/images/momlogo.png')}
          style={styles.logo}
          resizeMode="contain"
        />
