  ...
  const handleSearch = () => {
    try {
      ...
      if (selectedBloodGroup) 
        filters.bloodGroup = selectedBloodGroup;
      if (selectedState) 
      ...
      // Log the navigation attempt and filters
      console.log('Attempting to navigate with filters:', filters);

      // Navigate using the correct path structure
      router.push({
